...
public class ProductInfoPage {
	...
	private final By metaData = By.xpath("(//div[@id='content']//ul[contains(@class,'list-unstyled')])[1]/li");
	private final By priceData = By.xpath("(//div[@id='content']//ul[contains(@class,'list-unstyled')])[2]/li");
	...
	public int getProductImagesCount() {
		int imagesCount = eleUtil.waitForAllElementsPresence(images, AppConstants.SHORT_TIME_OUT).size();
		System.out.println("total number of the images for product:" + getProductHeader() + ":" + imagesCount);
		return imagesCount;
	}
